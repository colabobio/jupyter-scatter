...
| `select_color`              | str \| tuple[float] \| list[float]                                                       | `(0, 0.666666667, 1, 1)`                       |
| `select_initiator`          | bool                                                                                     | `False`                                        |
| `select_min_delay`          | int                                                                                      | `10`                                           |
| `select_min_dist`           | int                                                                                      | `3`                                            |
| `select_on_long_press`      | bool                                                                                     | `True`                                         |
| `reticle`                  | bool                                                                                     | `True`                                         |
...
| `select_color`                            | str \| [float, float, float, float]                                                                                                                                  | `[0, 0.666666667, 1, 1]`                   |            |           |               |
| `select_min_delay`                        | int                                                                                                                                                                  | `10`                                       |            |           |               |
| `select_min_dist`                         | float                                                                                                                                                                | `3`                                        |            |           |               |
| `reticle`                                | bool                                                                                                                                                                 | `True`                                     |            |           |               |
